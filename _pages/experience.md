...
As a Software Engineer, I developed backend systems, optimizing the core risk scoring engine, cloud integrations, and data pipelines for the Automated UEBA platform, building Azure and AWS ingestion paths, expanding database activity monitoring, enhancing the log forwarding framework, and leading the Kubernetes migration of the on-premises codebase. My work also covered C++ sensor enhancements, self-service customer features, legacy system rewrites, and junior developer mentorship.
